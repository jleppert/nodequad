 ...
 * @param {Function} probeResultsCb callback to receive probe results after timeout has expired for all ports
 * @param {Function} connectCb if a callback is passed, automatically connect to first found vehicle and return once connected
 */
...
function probeAndConnect() {
	...
	return function callProbeAndConnect() {
		this.call(self, undefined, function(){});
	}
}