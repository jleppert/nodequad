 ...
 * @params {String} commands.getter getter character command
 * @params {String} commands.setter setter character command
 * @params {String} commands.stream stream character command
 * @params {Function} parser type of line parser to use
 * @params {Integer} lines number of lines in expected command response
 * @params {Array} mapping map of expected data to root object path, one or more value parsers   
 */
